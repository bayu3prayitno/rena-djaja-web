...
const Produk = () => {
  return (
    <section
      id="product"
      className="py-20 px-4 bg-red-50 transition-all duration-500 "
    >
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="flex flex-col md:flex-row items-center gap-12 justify-center">
          <div className="flex-shrink-0 flex items-center justify-center md:justify-end w-full md:w-auto">
            <img src="produk1.png" alt="Moto Cap Mobil" className="max-w-xs" />
          </div>
          <div className="text-left max-w-md">
            <h3 className="text-2xl font-bold text-red-600 mb-2 bg-gradient-to-r from-red-600 via-red-700 to-red-800 bg-clip-text text-transparent">
              Moto Cap Mobil
            </h3>
        ...
        <div className="bg-white flex flex-col sm:flex-row items-center sm:items-center gap-4 p-5 m-5 w-full sm:w-auto sm:max-w-none max-w-xl mx-auto rounded-md hover:shadow-xl transition-shadow">
          ...
          <p className="text-black text-sm text-justify leading-snug">
            Produk kami telah mendapatkan sertifikat halal dari Majelis Ulama
